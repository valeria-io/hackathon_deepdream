...
def tiled_gradient(gradient, image, session, tile_size=400):
...
def optimize_image(layer_tensor, image, session,
    ...
    for i in range(num_iterations):
        ...
        grad = tiled_gradient(gradient=gradient, image=img, session=session)
...
def recursive_optimize(layer_tensor, image, session,
